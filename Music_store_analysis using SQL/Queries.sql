-- Q)Who is the most senior most employee on job title?--
...
order by cnt desc;
-- USA,Canada & Brazil are the top three countries--
...
WHERE RowNo <= 1
ORDER BY total_spending ASC, RowNo DESC;
...
/*  THANK YOU
BY NAKUL SHARMA 
DATASET USED - MUSIC STORE DATA 
TOOL USED - MICROSOFT SQL SERVER 2022
ALSO USED CHAT_GPT  & MICROSOFT BING FOR MORE CREATIVITY AND BETTER ANALYSIS 
*/